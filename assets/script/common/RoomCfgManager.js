...
var RoomCfgManager = app.BaseClass.extend({
    ...
    GetRoomData:function(gameType,cfg){//gameType大写
        ...
        if('nn' == roomData.bigName1){
            ...
            if(1 == cfg.sign){
                roomData.smallName0 = '庄家扑克';
                roomData.smallName1 = 'sss_zz';
            }
            else if(2 == cfg.sign){
                roomData.smallName0 = '多人扑克';
        ...
        for(let key in this.gameCreateCfg){
            ...
            if(gameType == gameName && 1 == isWanFa){
                ...
                if(dataKey == "kexuanwanfa"){
                    if(gameType == 'pdk' || gameType == 'lcpdk' ||gameType == 'qjpdk' || gameType == 'jtpdk' || gameType == 'gapdk' || gameType == 'japdk' ||gameType == 'jxndpdk' || gameType == 'yxpdk' || gameType == 'ygpdk' || gameType == 'xgpdk' || gameType == 'hhpdk' || gameType == 'yzpdk' || gameType == 'xyxxpdk'){
                ...
                if(0 == ToggleType){
                    ...
                    for(let j = 0; j < value.length;j++){
                        ...
                        if(dataKey=="kexuanwanfa"){
                            ...
                            }else if (gameType == 'lppdk' || gameType == 'pdk' || gameType == 'lcpdk' ||gameType == 'qjpdk' || gameType == 'gapdk' || gameType == 'japdk'|| gameType == 'yxpdk' || gameType == 'wxpdk' ) {
                            ...
                            }else if(gameType == 'pdk' || gameType == 'lcpdk' || gameType == 'gapdk' || gameType == 'japdk' || gameType == 'yxpdk' || gameType == 'hspdk' || gameType == 'qjpdk' || gameType == 'wxpdk'){
                                if(value[j] == 14){
                                    continue;
                                }
                                if (value[j] == 11) {
