...
cc.Class({
    ...
    OnShow:function(shareObj,shareType){
        ...
        let shareUrl="http://108.187.1.61/"+this.ComTool.GetPid(heroID)+"/";
        let imgUrl = "http://108.187.1.61/makeQRcode.php?url=" + shareUrl;
        cc.assetManager.loadRemote({url:imgUrl,type: 'png'},function (err, texture) {
