...
cc.Class({
    ...
    OnCreateInit: function () {
        this.POSTURL="http://108.187.1.61/index.php?module=ApplicationAgent&action=setApply";
        this.GETURL="http://108.187.1.61/index.php?module=ApplicationAgent&action=getApply&playerID="+app.HeroManager().GetHeroProperty("pid");
