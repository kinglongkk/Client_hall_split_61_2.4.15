...
var LoopScrollView = cc.Class({
    ...
    InitScrollData:function(childComponentName, childFormPrefab, dataList, itemHeight=0, isScrollToLast){
        ...
        if(this.ScrollView.vertical){
            ...
            this.scrollDir = "horizontal";
                            ...
                            console.error("ScrollView not find scrollDir");
            return
        }
        ...
        if(this.scrollDir == "vertical"){
            ...
            if(itemHeight){
                ...
                if(!this.itemHeight){
                                    console.error("childFormPrefab not height");
                    return
                }
            }
            //设置滑动控件的最大滑动高度
            ...
            if(itemHeight){
                ...
                if(!this.itemWidth){
                                    console.error("childFormPrefab not width");
                    return
                }
            }
            //设置滑动控件的最大滑动高度
    ...
    CreateScrollViewChildForm:function(index, userData=0, pos=null, zorderLv=0, argument=null){
        ...
        if(!childFormComponent){
                            console.error("CreateChildForm childFormNode not find (%s)", this.scrollViewChildComponentName);
            return
        }
    ...
    ScrollToChild:function(userData){
        ...
        if(childIndex < 0){
                            console.error("ScrollToChild(%s) not find", userData);
            return
        }
        if(this.scrollDir == "vertical"){
    ...
    OnCheckReusability:function(){
        ...
        if(this.scrollDir == "vertical"){
            ...
            this.OnCheckHorizontalReusability();
                            ...
                            console.error("scrollDir:%s", this.scrollDir)
        }
        ...
        for (let index = 0; index < childCount; index++) {
            ...
            if(isLeft) {
                ...
                if (viewPos.x + this.itemWidth*(1-this.itemAnchorX) < limitLeft){
                    ...
                    //                console.error("Left (%s) newPosX:%s,%s", index, newPosX, childFormNode.x);
                    ...
                    if(newPosX < this.ScrollView.content.width){
                        ...
                        if(userData){
                            ...
                            childFormComponent.OnShow();
                                            ...
                                            console.error("Left childIndex(%s,%s)=>(%s,%s)", childIndex, oldUserData, newChildIndex, userData);
                        }
                ...
                if (viewPos.x - this.itemWidth*this.itemAnchorX > limitRight){
                    ...
                    //                console.error("Right (%s) newPosX:%s,%s", index, newPosX, childFormNode.x);
                    ...
                    if(newPosX > 0){
                        ...
                        if(userData){
                            ...
                            childFormComponent.OnShow();
                                            ...
                                            console.error("Right childIndex(%s,%s)=>(%s,%s)", childIndex, oldUserData, newChildIndex, userData);
                        }
        ...
        for (let index = 0; index < childCount; index++) {
            ...
            if(!isDown) {
                ...
                if (viewPos.y + this.itemHeight*(1-this.itemAnchorY) < limitDown){
                    ...
                    //                console.error("Down (%s) newPosY:%s,%s", index, newPosY, childFormNode.y);
                    ...
                    if(newPosY < 0){
                        ...
                        if(userData){
                            ...
                            childFormComponent.OnShow();
                                            ...
                                            console.error("Down childIndex(%s,%s)=>(%s,%s)", childIndex, oldUserData, newChildIndex, userData);
                        }
                    }
                }
            }
                ...
                if (viewPos.y - this.itemHeight*this.itemAnchorY > limitUp){
                    ...
                    let newPosY = childFormNode.y - allChildFormLength;
                    //                console.error("UP (%s) newPosY:%s,%s", index, newPosY, childFormNode.y);
                    ...
                    if(newPosY > -this.ScrollView.content.height){
                        ...
                        if(userData){
                            ...
                            childFormComponent.OnShow();
                                            ...
                                            console.error("Up childIndex(%s,%s)=>(%s,%s)", childIndex, oldUserData, newChildIndex, userData);
                        }
                    }
                }
            }
