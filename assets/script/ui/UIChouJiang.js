...
cc.Class({
    ...
    OnShow:function(luckDrawData,luckDrawSprs){
        ...
        if (cc.sys.isNative) {
            this.getRecordUrl = "http://108.187.1.61/index.php?module=Api&action=GetLuckRecords&pid="+heroID;
            this.getRecordByTypeUrl = "http://108.187.1.61/index.php?module=Api&action=GetLuckRecords&pid="+heroID+"&type=8";
        }else{
            this.getRecordUrl = "http://108.187.1.61/index.php?module=Api&action=GetLuckRecords&pid="+heroID;
            this.getRecordByTypeUrl = "http://108.187.1.61/index.php?module=Api&action=GetLuckRecords&pid="+heroID+"&type=8";
        }
