    ...
    */
    ...
    OnBuyBtnClick:function(event){
        ...
        if(this.curRefreshTabel == this.RefreshType.leDou){
            ...
            cc.sys.openURL("http://"+this.httpPath+"/index.php?module=XinHuaPay&action=Pay&goodsID="+this.appID+"&playerID="+app.HeroManager().GetHeroProperty("pid")+"&cityId="+allSelectCityData[0]['selcetId']);
