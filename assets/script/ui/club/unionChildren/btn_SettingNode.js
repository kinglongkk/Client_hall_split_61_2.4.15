...
cc.Class({
    ...
    InitData:function (clubId, unionId, unionPostType,myisminister) {
        ...
        this.aiSetting = this.node.getChildByName("UIAISetting");//zhaozw
    ...
    UpdateData:function(serverPack){
        this.aiSetting.getChildByName("robotNum").getComponent(cc.EditBox).string = serverPack.robotNum;
        this.aiSetting.getChildByName("robotInitScore").getComponent(cc.EditBox).string = serverPack.robotInitScore;
    ...
    GetSetConfig:function(){
        ...
        sendPack.robotNum = this.aiSetting.getChildByName("robotNum").getComponent(cc.EditBox).string;
        sendPack.robotInitScore = this.aiSetting.getChildByName("robotInitScore").getComponent(cc.EditBox).string;
        return sendPack;
    },
    //控件点击回调
    ...
    OnClick:function(btnName, btnNode){
        ...
        }else if(btnName == "btn_jqr"){//zhaozw 

            console.log("OnClick_BtnWnd 2:"+btnName);
	        let sendPack = this.GetSetConfig();
	        if (sendPack == null) {
            console.log("OnClick_BtnWnd 3:"+btnName);
	            return;
	        }
            console.log("OnClick_BtnWnd 5:"+btnName);
