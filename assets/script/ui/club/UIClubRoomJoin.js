...
cc.Class({
    ...
    OnShow: function(roomData) {
        ...
        if (this.unionId > 0) {
            ...
            this.SetWndProperty("left/wanfaScrollView/view/roominfo/lb_EveryoneConsume", "active", true);
            ...
            this.SetWndProperty("left/wanfaScrollView/view/roominfo/lb_EveryoneConsume", "text", "每人付：" + roomCfg.roomSportsEveryoneConsume);
                let PLDecStr = "";
