...
cc.Class({
    ...
    OnShow: function () {
        ...
        if (cc.sys.isNative) {
            this.ChouJiangUrl='http://108.187.1.61/index.php?module=Api&action=GetLuckGoods';
            this.WenJuanUrl="http://108.187.1.61/mu?module=Api&action=GetQuestionnaire&pid="+heroID;
            this.IpUrl='http://108.187.1.61/myip.php';
            this.KeFuUrl = "http://108.187.1.61/index.php?module=Api&action=Contact";
        }else{
            this.ChouJiangUrl='http://108.187.1.61/index.php?module=Api&action=GetLuckGoods';
            this.WenJuanUrl="http://108.187.1.61/mu?module=Api&action=GetQuestionnaire&pid="+heroID;
            this.IpUrl='http://108.187.1.61/myip.php';
